/*
 * Single-precision vector atanpi(x) function.
 *
...
TEST_ULP (V_NAME_F1 (atanpi), 2.09)
TEST_DISABLE_FENV (V_NAME_F1 (atanpi))
TEST_SYM_INTERVAL (V_NAME_F1 (atanpi), 0, 0x1p-30, 5000)
TEST_SYM_INTERVAL (V_NAME_F1 (atanpi), 0x1p-30, 1, 40000)
TEST_SYM_INTERVAL (V_NAME_F1 (atanpi), 1, 0x1p30, 40000)
TEST_SYM_INTERVAL (V_NAME_F1 (atanpi), 0x1p30, inf, 1000)
#endif