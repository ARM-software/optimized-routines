/*
 * Single-precision vector asinpi(x) function.
 *
...
TEST_SYM_INTERVAL (V_NAME_F1 (asinpi), 0x1p-31, 0.5, 10000)
TEST_SYM_INTERVAL (V_NAME_F1 (asinpi), 0.5, 0x1p32f, 10000)
TEST_SYM_INTERVAL (V_NAME_F1 (asinpi), 0x1p32f, inf, 10000)
#endif
