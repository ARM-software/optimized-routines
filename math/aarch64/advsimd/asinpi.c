/*
 * Double-precision vector asinpi(x) function.
 *
...
TEST_INTERVAL (V_NAME_D1 (asinpi), 0x1p-31, 0.5, 10000)
TEST_INTERVAL (V_NAME_D1 (asinpi), 0.5, 0x1p32f, 10000)
TEST_INTERVAL (V_NAME_D1 (asinpi), 0x1p32f, inf, 10000)
TEST_INTERVAL (V_NAME_D1 (asinpi), 1.0, 0x1p11, 50000)
TEST_INTERVAL (V_NAME_D1 (asinpi), 0x1p11, inf, 20000)
TEST_INTERVAL (V_NAME_D1 (asinpi), -0, -inf, 20000)
#endif
