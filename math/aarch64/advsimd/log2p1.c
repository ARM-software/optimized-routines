/*
 * doube-precision vector log2(1+x) function.
 *
...
#if WANT_C23_TESTS
TEST_DISABLE_FENV (V_NAME_D1 (log2p1))
TEST_ULP (V_NAME_D1 (log2p1), 2.5)
TEST_SYM_INTERVAL (V_NAME_D1 (log2p1), 0.0, 0x1p-23, 30000)
TEST_SYM_INTERVAL (V_NAME_D1 (log2p1), 0x1p-23, 1, 50000)
TEST_INTERVAL (V_NAME_D1 (log2p1), 1, inf, 50000)
TEST_INTERVAL (V_NAME_D1 (log2p1), -1.0, -inf, 1000)
#endif
