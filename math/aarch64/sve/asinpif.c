...
TEST_INTERVAL (SV_NAME_F1 (asinpi), 0.5, 1.0, 50000)
TEST_INTERVAL (SV_NAME_F1 (asinpi), 1.0, 0x1p11, 50000)
TEST_INTERVAL (SV_NAME_F1 (asinpi), 0x1p11, inf, 20000)
TEST_INTERVAL (SV_NAME_F1 (asinpi), -0, -inf, 20000)
#endif
CLOSE_SVE_ATTR
