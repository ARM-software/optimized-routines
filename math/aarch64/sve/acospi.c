/*
 * Single-precision SVE acospi(x) function.
 *
...
TEST_INTERVAL (SV_NAME_D1 (acospi), 0x1p-31, 0.5, 10000)
TEST_INTERVAL (SV_NAME_D1 (acospi), 0.5, 0x1p32f, 10000)
TEST_INTERVAL (SV_NAME_D1 (acospi), 0x1p32f, inf, 10000)
#endif
CLOSE_SVE_ATTR
