...
TEST_ULP (SV_NAME_F1 (atanpi), 2.09)
TEST_DISABLE_FENV (SV_NAME_F1 (atanpi))
TEST_INTERVAL (SV_NAME_F1 (atanpi), 0.0, 1.0, 40000)
TEST_INTERVAL (SV_NAME_F1 (atanpi), 1.0, 100.0, 40000)
TEST_INTERVAL (SV_NAME_F1 (atanpi), 100, inf, 40000)
TEST_INTERVAL (SV_NAME_F1 (atanpi), -0, -inf, 40000)
#endif
CLOSE_SVE_ATTR
