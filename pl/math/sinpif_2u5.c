...
PL_TEST_INTERVAL (sinpif, 0, 0x1p-31, 5000)
PL_TEST_INTERVAL (sinpif, -0, -0x1p-31, 5000)
PL_TEST_INTERVAL (sinpif, 0x1p-31, 0.5, 10000)
PL_TEST_INTERVAL (sinpif, -0x1p-31, -0.5, 10000)
PL_TEST_INTERVAL (sinpif, 0.5, 0x1p22f, 10000)
PL_TEST_INTERVAL (sinpif, -0.5, -0x1p22f, 10000)
PL_TEST_INTERVAL (sinpif, 0x1p22f, inf, 10000)
PL_TEST_INTERVAL (sinpif, -0x1p22f, -inf, 10000)
PL_TEST_INTERVAL (sinpif, -inf, -inf, 1)
PL_TEST_INTERVAL (sinpif, inf, inf, 1)