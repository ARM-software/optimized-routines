...
PL_TEST_SYM_INTERVAL (SV_NAME_F1 (atanh), 0, 0x1p-12, 1000)
PL_TEST_SYM_INTERVAL (SV_NAME_F1 (atanh), 0x1p-12, 1, 20000)
PL_TEST_SYM_INTERVAL (SV_NAME_F1 (atanh), 1, inf, 1000)
...
PL_TEST_CONTROL_VALUE (SV_NAME_F1 (atanh), 0)
