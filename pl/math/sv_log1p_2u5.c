...
PL_TEST_INTERVAL (SV_NAME_D1 (log1p), 0.0, 0x1p-23, 50000)
PL_TEST_INTERVAL (SV_NAME_D1 (log1p), 0x1p-23, 0.001, 50000)
PL_TEST_INTERVAL (SV_NAME_D1 (log1p), 0.001, 1.0, 50000)
/* Sign of _ZGVsMxv_log1p (-0) does not match the reference.  */
PL_TEST_INTERVAL (SV_NAME_D1 (log1p), -0x0.0000000000001p-1022, -0x1p-23,
		  50000)
PL_TEST_INTERVAL (SV_NAME_D1 (log1p), -0x1p-23, -0.001, 50000)
PL_TEST_INTERVAL (SV_NAME_D1 (log1p), -0.001, -1.0, 50000)
PL_TEST_INTERVAL (SV_NAME_D1 (log1p), -1.0, inf, 5000)
