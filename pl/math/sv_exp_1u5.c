...
specialcase (svbool_t pg, sv_f64_t s, sv_f64_t y, sv_f64_t n)
{
  ...
  sv_f64_t r2 = sv_fma_f64_x (pg, y, s2, s2);
  sv_f64_t r0 = svmul_f64_x (pg, r2, s1);
...
sv_f64_t
__sv_exp_x (sv_f64_t x, const svbool_t pg)
{
  ...
  sv_f64_t z = sv_fma_n_f64_x (pg, InvLn2, x, sv_f64 (Shift));
  sv_u64_t u = sv_as_u64_f64 (z);
  sv_f64_t n = svsub_n_f64_x (pg, z, Shift);

  /* r = x - n * ln2, r is in [-ln2/(2N), ln2/(2N)].  */
  sv_f64_t r = sv_fma_n_f64_x (pg, -Ln2hi, n, x);
  r = sv_fma_n_f64_x (pg, -Ln2lo, n, r);

  /* y = exp(r) - 1 ~= r + C0 r^2 + C1 r^3 + C2 r^4 + C3 r^5.  */
  sv_f64_t r2 = svmul_f64_x (pg, r, r);
  sv_f64_t c2_c3r = sv_fma_n_f64_x (pg, C (3), r, sv_f64 (C (2)));
  sv_f64_t c0_c1r = sv_fma_n_f64_x (pg, C (1), r, sv_f64 (C (0)));
  sv_f64_t c0_to_3 = sv_fma_f64_x (pg, r2, c2_c3r, c0_c1r);
  sv_f64_t y = sv_fma_f64_x (pg, r2, c0_to_3, r);
