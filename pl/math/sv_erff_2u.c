...
PL_TEST_INTERVAL (SV_NAME_F1 (erf), 0, 0x1.cp-7, 40000)
PL_TEST_INTERVAL (SV_NAME_F1 (erf), -0, -0x1.cp-7, 40000)
PL_TEST_INTERVAL (SV_NAME_F1 (erf), 0x1.cp-7, 3.9375, 40000)
PL_TEST_INTERVAL (SV_NAME_F1 (erf), -0x1.cp-7, -3.9375, 40000)
PL_TEST_INTERVAL (SV_NAME_F1 (erf), 3.9375, inf, 40000)
PL_TEST_INTERVAL (SV_NAME_F1 (erf), -3.9375, -inf, 40000)
PL_TEST_INTERVAL (SV_NAME_F1 (erf), 0, inf, 4000)
PL_TEST_INTERVAL (SV_NAME_F1 (erf), -0, -inf, 4000)
