...
PL_TEST_INTERVAL_C (SV_NAME_D1 (atanh), 0, 0x1p-23, 10000, 0)
PL_TEST_INTERVAL_C (SV_NAME_D1 (atanh), -0, -0x1p-23, 10000, 0)
PL_TEST_INTERVAL_C (SV_NAME_D1 (atanh), 0x1p-23, 1, 90000, 0)
PL_TEST_INTERVAL_C (SV_NAME_D1 (atanh), -0x1p-23, -1, 90000, 0)
PL_TEST_INTERVAL_C (SV_NAME_D1 (atanh), 1, inf, 100, 0)
PL_TEST_INTERVAL_C (SV_NAME_D1 (atanh), -1, -inf, 100, 0)
