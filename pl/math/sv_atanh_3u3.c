...
PL_TEST_SYM_INTERVAL (SV_NAME_D1 (atanh), 0, 0x1p-23, 10000)
PL_TEST_SYM_INTERVAL (SV_NAME_D1 (atanh), 0x1p-23, 1, 90000)
PL_TEST_SYM_INTERVAL (SV_NAME_D1 (atanh), 1, inf, 100)
...
PL_TEST_CONTROL_VALUE (SV_NAME_D1 (atanh), 0)
