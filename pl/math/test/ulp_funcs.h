...
F (v_sincos_sin, v_sincos_sin, sinl, mpfr_sin, 1, 0, d1, 0)
F (v_sincos_cos, v_sincos_cos, cosl, mpfr_cos, 1, 0, d1, 0)
F (v_cexpi_sin, v_cexpi_sin, sinl, mpfr_sin, 1, 0, d1, 0)
F (v_cexpi_cos, v_cexpi_cos, cosl, mpfr_cos, 1, 0, d1, 0)

#if WANT_SVE_MATH
F (_ZGVsMxvv_powk, Z_sv_powk, ref_powi, mpfr_powi, 2, 0, d2, 0)
F (_ZGVsMxvv_powi, Z_sv_powi, ref_powif, mpfr_powi, 2, 1, f2, 0)

F (sv_sincosf_sin, sv_sincosf_sin, sin, mpfr_sin, 1, 1, f1, 0)
