...
PL_TEST_INTERVAL (cospi, 0, 0x1p-63, 5000)
PL_TEST_INTERVAL (cospi, -0, -0x1p-63, 5000)
PL_TEST_INTERVAL (cospi, 0x1p-63, 0.5, 10000)
PL_TEST_INTERVAL (cospi, 0x1p-63, 0.5, 10000)
PL_TEST_INTERVAL (cospi, 0.5, 0x1p51f, 10000)
PL_TEST_INTERVAL (cospi, -0.5, -0x1p51f, 10000)
PL_TEST_INTERVAL (cospi, 0x1p51f, inf, 10000)
PL_TEST_INTERVAL (cospi, -0x1p51f, -inf, 10000)