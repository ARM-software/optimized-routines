...
PL_TEST_INTERVAL (SV_NAME_F1 (tanh), 0, 0x1p-23, 1000)
PL_TEST_INTERVAL (SV_NAME_F1 (tanh), -0, -0x1p-23, 1000)
PL_TEST_INTERVAL (SV_NAME_F1 (tanh), 0x1p-23, 0x1.205966p+3, 100000)
PL_TEST_INTERVAL (SV_NAME_F1 (tanh), -0x1p-23, -0x1.205966p+3, 100000)
PL_TEST_INTERVAL (SV_NAME_F1 (tanh), 0x1.205966p+3, inf, 100)
PL_TEST_INTERVAL (SV_NAME_F1 (tanh), -0x1.205966p+3, -inf, 100)
