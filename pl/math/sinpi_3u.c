...
PL_TEST_INTERVAL (sinpi, 0, 0x1p-63, 5000)
PL_TEST_INTERVAL (sinpi, -0, -0x1p-63, 5000)
PL_TEST_INTERVAL (sinpi, 0x1p-63, 0.5, 10000)
PL_TEST_INTERVAL (sinpi, 0x1p-63, 0.5, 10000)
PL_TEST_INTERVAL (sinpi, 0.5, 0x1p51, 10000)
PL_TEST_INTERVAL (sinpi, -0.5, -0x1p51, 10000)
PL_TEST_INTERVAL (sinpi, 0x1p51, inf, 10000)
PL_TEST_INTERVAL (sinpi, -0x1p51, -inf, 10000)