...
PL_TEST_INTERVAL (cospif, 0, 0x1p-31, 5000)
PL_TEST_INTERVAL (cospif, -0, -0x1p-31, 5000)
PL_TEST_INTERVAL (cospif, 0x1p-31, 0.5, 10000)
PL_TEST_INTERVAL (cospif, -0x1p-31, -0.5, 10000)
PL_TEST_INTERVAL (cospif, 0.5, 0x1p22f, 10000)
PL_TEST_INTERVAL (cospif, -0.5, -0x1p22f, 10000)
PL_TEST_INTERVAL (cospif, 0x1p22f, inf, 10000)
PL_TEST_INTERVAL (cospif, -0x1p22f, -inf, 10000)
PL_TEST_INTERVAL (cospif, inf, inf, 1)
PL_TEST_INTERVAL (cospif, -inf, -inf, 1)