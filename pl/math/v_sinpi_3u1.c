...
float64x2_t VPCS_ATTR V_NAME_D1 (sinpi) (float64x2_t x)
{
  ...
  float64x2_t r
      = vreinterpretq_f64_u64 (vbicq_u64 (vreinterpretq_u64_f64 (x), cmp));
#else
  float64x2_t r = x;
#endif
...
PL_TEST_INTERVAL (V_NAME_D1 (sinpi), 0, 0x1p-63, 5000)
PL_TEST_INTERVAL (V_NAME_D1 (sinpi), -0, -0x1p-63, 5000)
PL_TEST_INTERVAL (V_NAME_D1 (sinpi), 0x1p-63, 0.5, 10000)
PL_TEST_INTERVAL (V_NAME_D1 (sinpi), -0x1p-63, -0.5, 10000)
PL_TEST_INTERVAL (V_NAME_D1 (sinpi), 0.5, 0x1p51, 10000)
PL_TEST_INTERVAL (V_NAME_D1 (sinpi), -0.5, -0x1p51, 10000)
PL_TEST_INTERVAL (V_NAME_D1 (sinpi), 0x1p51, inf, 10000)
PL_TEST_INTERVAL (V_NAME_D1 (sinpi), -0x1p51, -inf, 10000)
PL_TEST_INTERVAL (V_NAME_D1 (sinpi), inf, inf, 1)
PL_TEST_INTERVAL (V_NAME_D1 (sinpi), -inf, -inf, 1)
PL_TEST_INTERVAL (V_NAME_D1 (sinpi), nan, nan, 1)
PL_TEST_INTERVAL (V_NAME_D1 (sinpi), -nan, -nan, 1)