...
PL_TEST_INTERVAL (SV_NAME_F1 (cosh), 0, 0x1p-63, 100)
PL_TEST_INTERVAL (SV_NAME_F1 (cosh), 0, 0x1.5a92d8p+6, 80000)
PL_TEST_INTERVAL (SV_NAME_F1 (cosh), 0x1.5a92d8p+6, inf, 2000)
PL_TEST_INTERVAL (SV_NAME_F1 (cosh), -0, -0x1p-63, 100)
PL_TEST_INTERVAL (SV_NAME_F1 (cosh), -0, -0x1.5a92d8p+6, 80000)
PL_TEST_INTERVAL (SV_NAME_F1 (cosh), -0x1.5a92d8p+6, -inf, 2000)
