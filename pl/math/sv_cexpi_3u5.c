...
special_case (svfloat64_t x, svbool_t special, svfloat64x2_t y) SC_ATTR
{
...
svfloat64x2_t SV_NAME_D1 (cexpi) (svfloat64_t x, svbool_t pg) SC_ATTR
{
...
PL_TEST_ULP (SV_NAME_D1 (cexpi_sin), 2.73)
PL_TEST_ULP (SV_NAME_D1 (cexpi_cos), 2.73)
#define SV_CEXPI_INTERVAL(lo, hi, n)                                          \
  PL_TEST_INTERVAL (SV_NAME_D1 (cexpi_sin), lo, hi, n)                        \
  PL_TEST_INTERVAL (SV_NAME_D1 (cexpi_cos), lo, hi, n)
