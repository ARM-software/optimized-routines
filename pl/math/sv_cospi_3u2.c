...
PL_TEST_INTERVAL (SV_NAME_D1 (cospi), 0, 0x1p-63, 5000)
PL_TEST_INTERVAL (SV_NAME_D1 (cospi), -0, -0x1p-63, 5000)
PL_TEST_INTERVAL (SV_NAME_D1 (cospi), 0x1p-63, 0.5, 10000)
PL_TEST_INTERVAL (SV_NAME_D1 (cospi), -0x1p-63, -0.5, 10000)
PL_TEST_INTERVAL (SV_NAME_D1 (cospi), 0.5, 0x1p51, 10000)
PL_TEST_INTERVAL (SV_NAME_D1 (cospi), -0.5, -0x1p51, 10000)
PL_TEST_INTERVAL (SV_NAME_D1 (cospi), 0x1p51, inf, 100000)
PL_TEST_INTERVAL (SV_NAME_D1 (cospi), -0x1p51, -inf, 10000)
PL_TEST_INTERVAL (SV_NAME_D1 (cospi), inf, inf, 1)
PL_TEST_INTERVAL (SV_NAME_D1 (cospi), -inf, -inf, 1)
PL_TEST_INTERVAL (SV_NAME_D1 (cospi), nan, nan, 1)
PL_TEST_INTERVAL (SV_NAME_D1 (cospi), -nan, -nan, 1)